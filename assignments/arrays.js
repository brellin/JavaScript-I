...
const thirtyThree = inventory.filter(car => car.id === 33)[0]
console.log(`${thirtyThree.car_year} ${thirtyThree.car_make} ${thirtyThree.car_model}`)
...
const sorted = inventory.sort((car, prev) => car.car_model.toLowerCase() < prev.car_model.toLowerCase() ? -1 : 1)
console.log(sorted)
...
console.log(BMWAndAudi)// JSON.stringify() is not required...
